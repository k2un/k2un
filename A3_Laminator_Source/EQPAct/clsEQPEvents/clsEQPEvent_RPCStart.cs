...
namespace EQPAct
{
    public class clsEQPEvent_RPCStart : clsEQPEvent, IEQPEvent
    {
        #region Variables
        ...
        #region Constructors
        public clsEQPEvent_RPCStart(string strUnitID)
        {
            strUnitID = strUnitID;
            strEventName = "actRPCSTART";
        }
        #endregion
        ...
        public void funProcessEQPEvent(string[] parameters)
        {
            ...
            try
            {
                ...
                this.pInfo.subSendSF_Set(InfoAct.clsInfo.SFName.S16F131RPCStart, dstrHGLSID);
            }
            catch (Exception ex)
            {
