...
namespace EQPAct
{
    public class clsCimEventHostDisconnect : clsCIMEvent, ICIMEvent
    {
        #region Variables
        #endregion
        ...
        #region Constructors
        public clsCimEventHostDisconnect(string strUnitID)
        {
            strUnitID = strUnitID;
            strEventName = "HOSTDisconnect";
        }
        #endregion
