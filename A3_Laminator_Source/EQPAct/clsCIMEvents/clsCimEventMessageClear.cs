...
namespace EQPAct
{
    public class clsCimEventMessageClear : clsCIMEvent, ICIMEvent
    {
        #region Variables
        #endregion
        ...
        #region Constructors
        public clsCimEventMessageClear(string strUnitID)
        {
            strUnitID = strUnitID;
            strEventName = "MessageClear";
        }
        #endregion
        ...
        {
            string dstrBitAddress = "B1004";
            try
            {
                pEqpAct.funBitWrite("B1004", "1");
                pEqpAct.funBitWrite("B1006", "1");
            }
            catch (Exception ex)
            {
