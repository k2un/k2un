...
namespace HostAct
{
    public class clsHostAct
    {
        #region "선언"
            ...
            {
                get { return "Samsung SDI PDCLN V1.0"; }
            }

            private SDIPDCLN.SEComSDIPDCLNClass PSecsDrv;         //외부 DLL을 사용하기 위핸 SecomDriver를 정의한다.
        ...
        #region"Open and Close"
            ...
            public int funOpenSecsDrv(string strEQPID)
            {
                ...
                try
                {
                    ...
                    this.PSecsDrv = new SDIPDCLN.SEComSDIPDCLNClass();

                    //Secs Drive의 이벤트 등록
                    subRegisterEvent();

                    //Open을 시도한다.
                    dintReturn = this.PSecsDrv.initializePlugIn(strEQPID, SEComPlugInLib.
                    ...
                    {
                        this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, "clsHostAct(funOpenSecsDrv), SECom Driver Open Error. dintReturn: " + dintReturn.ToString());   //Open이 되지 않아 에러가 발생한 경우
                    }
        ...
        private void subRegisterEvent()
        {
            try
            {
                this.PSecsDrv.SECSConnected += new SDIPDCLN.__SEComSDIPDCLN_SECSConnectedEventHandler(PSecsDrv_SECSConnected);
                this.PSecsDrv.SECSDisconnected += new SDIPDCLN.__SEComSDIPDCLN_SECSDisconnectedEventHandler(PSecsDrv_SECSDisconnected);
                this.PSecsDrv.SECSTimeout += new SDIPDCLN.__SEComSDIPDCLN_SECSTimeoutEventHandler(PSecsDrv_SECSTimeout);
                this.PSecsDrv.SECSInvalidMessage += new SDIPDCLN.__SEComSDIPDCLN_SECSInvalidMessageEventHandler(PSecsDrv_SECSInvalidMessage);
                this.PSecsDrv.SECSAbortedMessage += new SDIPDCLN.__SEComSDIPDCLN_SECSAbortedMessageEventHandler(PSecsDrv_SECSAbortedMessage);
                this.PSecsDrv.SECSUnknownMessage += new SDIPDCLN.__SEComSDIPDCLN_SECSUnknownMessageEventHandler(PSecsDrv_SECSUnknownMessage);
                this.PSecsDrv.SEComDrvError += new SDIPDCLN.__SEComSDIPDCLN_SEComDrvErrorEventHandler(PSecsDrv_SEComDrvError);
                this.PSecsDrv.SEComDrvShutdown +=new SDIPDCLN.__SEComSDIPDCLN_SEComDrvShutdownEventHandler(PSecsDrv_SEComDrvShutdown);

                this.PSecsDrv.__SEComSDIPDCLN_Event_AreYouThere +=new SDIPDCLN.__SEComSDIPDCLN_AreYouThereEventHandler(PSecsDrv_AreYouThere);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S1F2IAmHere += new SDIPDCLN.__SEComSDIPDCLN_S1F2IAmHereEventHandler(PSecsDrv_S1F2IAmHere);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S10F3 +=new SDIPDCLN.__SEComSDIPDCLN_S10F3EventHandler(PSecsDrv_S10F3);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S10F9 +=new SDIPDCLN.__SEComSDIPDCLN_S10F9EventHandler(PSecsDrv_S10F9);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S1F11 +=new SDIPDCLN.__SEComSDIPDCLN_S1F11EventHandler(PSecsDrv_S1F11);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S1F15 +=new SDIPDCLN.__SEComSDIPDCLN_S1F15EventHandler(PSecsDrv_S1F15);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S1F17 +=new SDIPDCLN.__SEComSDIPDCLN_S1F17EventHandler(PSecsDrv_S1F17);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S1F3 +=new SDIPDCLN.__SEComSDIPDCLN_S1F3EventHandler(PSecsDrv_S1F3);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S1F5 +=new SDIPDCLN.__SEComSDIPDCLN_S1F5EventHandler(PSecsDrv_S1F5);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F101 +=new SDIPDCLN.__SEComSDIPDCLN_S2F101EventHandler(PSecsDrv_S2F101);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F103 +=new SDIPDCLN.__SEComSDIPDCLN_S2F103EventHandler(PSecsDrv_S2F103);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F15 +=new SDIPDCLN.__SEComSDIPDCLN_S2F15EventHandler(PSecsDrv_S2F15);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F23 +=new SDIPDCLN.__SEComSDIPDCLN_S2F23EventHandler(PSecsDrv_S2F23);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F29 +=new SDIPDCLN.__SEComSDIPDCLN_S2F29EventHandler(PSecsDrv_S2F29);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F31 +=new SDIPDCLN.__SEComSDIPDCLN_S2F31EventHandler(PSecsDrv_S2F31);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F41EQPCMD +=new SDIPDCLN.__SEComSDIPDCLN_S2F41EQPCMDEventHandler(PSecsDrv_S2F41EQPCMD);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S2F41PROCCMD +=new SDIPDCLN.__SEComSDIPDCLN_S2F41PROCCMDEventHandler(PSecsDrv_S2F41PROCCMD);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S3F1 +=new SDIPDCLN.__SEComSDIPDCLN_S3F1EventHandler(PSecsDrv_S3F1);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S5F101 +=new SDIPDCLN.__SEComSDIPDCLN_S5F101EventHandler(PSecsDrv_S5F101);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S5F2 +=new SDIPDCLN.__SEComSDIPDCLN_S5F2EventHandler(PSecsDrv_S5F2);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S5F3 +=new SDIPDCLN.__SEComSDIPDCLN_S5F3EventHandler(PSecsDrv_S5F3);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S5F5 += new SDIPDCLN.__SEComSDIPDCLN_S5F5EventHandler(PSecsDrv_S5F5);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S5F7 += new SDIPDCLN.__SEComSDIPDCLN_S5F7EventHandler(PSecsDrv_S5F7);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S6F12 +=new SDIPDCLN.__SEComSDIPDCLN_S6F12EventHandler(PSecsDrv_S6F12);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S6F14 +=new SDIPDCLN.__SEComSDIPDCLN_S6F14EventHandler(PSecsDrv_S6F14);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S6F19 +=new SDIPDCLN.__SEComSDIPDCLN_S6F19EventHandler(PSecsDrv_S6F19);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F1 +=new SDIPDCLN.__SEComSDIPDCLN_S7F1EventHandler(PSecsDrv_S7F1);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F101 +=new SDIPDCLN.__SEComSDIPDCLN_S7F101EventHandler(PSecsDrv_S7F101);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F103 +=new SDIPDCLN.__SEComSDIPDCLN_S7F103EventHandler(PSecsDrv_S7F103);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F105 +=new SDIPDCLN.__SEComSDIPDCLN_S7F105EventHandler(PSecsDrv_S7F105);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F108 +=new SDIPDCLN.__SEComSDIPDCLN_S7F108EventHandler(PSecsDrv_S7F108);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F109 +=new SDIPDCLN.__SEComSDIPDCLN_S7F109EventHandler(PSecsDrv_S7F109);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F23 +=new SDIPDCLN.__SEComSDIPDCLN_S7F23EventHandler(PSecsDrv_S7F23);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F25 +=new SDIPDCLN.__SEComSDIPDCLN_S7F25EventHandler(PSecsDrv_S7F25);
                this.PSecsDrv.__SEComSDIPDCLN_Event_S7F33 +=new SDIPDCLN.__SEComSDIPDCLN_S7F33EventHandler(PSecsDrv_S7F33);
        ...
        private void PSecsDrv_SECSConnected(string theEquipmentID)
        {
            try
            {
                ...
                //{
                    ...
                    {
                        //if (PInfo.All.ControlStateOLD == "")   //이전상태 기억 못하는 경우(프로그램 최초 기동시) Offline -> Online으로 전환한다.
                        //{
                        ...
                        //}
                        //else  //이전상태기억하는 경우(즉, Offline에서 통신이끊어지고 다시 통신이 붙으면 Online Remote로 전환한다.)
                        //{
                        //    //PLC에게만 Offline임을 써준다.
                        //    //this.PInfo.subPLCCommand_Set(InfoAct.clsInfo.PLCCommand.ControlState, PInfo.All.ControlState);
                        //}
        ...
        void PSecsDrv_SEComDrvShutdown(short theErrorCode, string theErrorMsg)
        {
            try
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, "PSecsDrv_SEComDrvShutdown()");
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        private void subS1F17()
        {
            ...
            try
            {
                ...
                if (dstrMCMD == "2")        //Online Local은 사용안함
                {
                    this.PSecsDrv.S1F18.MODULEID = dstrModuleID;
                    this.PSecsDrv.S1F18.ONLACK = 5;         //5 = ON_LINE LOCAL Not Allowed.
                    this.PSecsDrv.S1F18.Reply(this.PSecsDrv.S1F17.Header);
                    return;
                }
                ...
                if ((dintACK == 0) && (dstrMCMD == "3"))
                {
                    ...
                    //HOST로 Online 변경 보고를 한다.(S6F11, CEID=73(Remote))
                ...
                switch (dstrSFCD)
                {
                            ...
                            for (int dintUnit = 1; dintUnit <= this.PInfo.UnitCount; dintUnit++)
                            {
                                foreach (string dstrGLSID in this.PInfo.Unit(dintUnit).SubUnit(0).CurrGLS())
                                {
                                    ...
                                    if (dhtGLSID.ContainsKey(dstrGLSID) == false && this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).Scrap == false)
                                    {
                                        ...
                                        this.PSecsDrv.S1F6SFCD3.set_PANELPAIRPROPERTY(dintIndex, 0);
                    ...
                    case "4":       //각 Unit(Module) 상태 보고
                        ...
                        for (int dintLoop = 1; dintLoop <= this.PInfo.UnitCount; dintLoop++)
                        {
                            ...
                            this.PSecsDrv.S1F6SFCD4.set_LAYER2COUNT(dintLoop, 0);
                        }
        ...
        //  Description   : Host로부터 EQP Online Parameter(EOID) 변경 요청을 받았을때
        //  Parameters    : None
        //  Return Value  : None
        ...
        private void subS2F103()
        {
            ...
            try
            {
                ...
                //ModuleID가 존재하지 않는 경우
                //if (dstrModuleID != this.PInfo.Unit(0).SubUnit(0).ModuleID)
                if ((dstrModuleID != this.PInfo.Unit(0).SubUnit(0).ModuleID) && (dstrModuleID != this.PInfo.Unit(2).SubUnit(0).ModuleID))
                {
                    ...
                    for (int dintLoop2 = 1; dintLoop2 <= dintEOMDCount; dintLoop2++)
                    {
                        ...
                        if (dintEOID == 1 || dintEOID == 2 || dintEOID == 3)
                        {
                            if (dintEOMD == 0)
                            {
                                ...
                                //if (dintEOV == 0 || dintEOV == 1 || dintEOV == 2)
                                if (dintEOV >= this.PInfo.Unit(0).SubUnit(0).EOID(dintIndex).Min && dintEOV <= this.PInfo.Unit(0).SubUnit(0).EOID(dintIndex).Max)
                                {
                        ...
                        else if (dintEOID == 4 || dintEOID == 15 || dintEOID == 16)  //EQP Process State Time Over, VCR Reading Mode, Wait time for glassid key-input.(At reading fail)
                        {
                            //EOMD, EOMD값으로 Index를 찾는다.(Index가 Key값이기 떄문)
                            dintIndex = this.PInfo.funGetEOIDEOMDToIndex(dintEOID, dintEOMD);
                            ...
                            if (this.PInfo.Unit(0).SubUnit(0).EOID(dintIndex) == null)
                            {
                                dbolFail = true;    //유효성 검사에서 에러임을 저장
                                dintEAC = 3;   //NAK로 응답
                            }
                            else
                            {
                                if (this.PInfo.Unit(0).SubUnit(0).EOID(dintIndex).EOV != dintEOV)
                                {
                                    ...
                                    if (dintEOV >= this.PInfo.Unit(0).SubUnit(0).EOID(dintIndex).Min && dintEOV <= this.PInfo.Unit(0).SubUnit(0).EOID(dintIndex).Max)   //시간(분)은 0~99분까지만 온다.
                                    {
                                         dintEAC = 0;    //정상
                                    }
                                    else
                        ...
                        //else if (dintEOID == 15)  //VCR Reading Mode
                        //{
                        //}
                        //else if (dintEOID == 16)  //Wait time for glassid key-input.(At reading fail)
                        //{
                        //}
                        else  //존재하지 않는 EOID
                        {
                        ...
                        else  //에러일 경우 무조건 2로 보낸다.
                        {
                            dintMIACK = 2;  //2 = Denied, Busy
                        }

                        this.PSecsDrv.S2F104.MIACK = dintMIACK;
                ...
                if (dbolFail == false)
                {
                    ...
                    for (int dintLoop = 1; dintLoop <= dintEOIDCount; dintLoop++)
                    {
                        ...
                        for (int dintLoop2 = 1; dintLoop2 <= dintEOMDCount; dintLoop2++)
                        {
                            ...
                            if (this.PInfo.funGetEOIDLapseTime(dintIndex) == true) dbolEQPProcessTimeOverReset = true;
                    ...
                    //최종 수정된 날짜 Ini에 변경
                    FunINIMethod.subINIWriteValue("ETCInfo", "EOIDLastModified", DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), this.PInfo.All.SystemINIFilePath);
                }
        ...
        private void subS2F41EQPCMD()
        {
            ...
            try
            {
                ...
                {
                    //51(Pause)은 Layer1도 대응하고 Layer2단이 오면 Layer1로 Pause 명령을 내린다.
                    //52(Resume), 53(PM), 54(Normal)는 Layer1만 대응한다.(Layer2단 오면 NAK로 응답)
                    if (dstrRCMD == "51")  //51(Pause)은 Layer1도 대응하고 Layer2단이 오면 Layer1로 Pause 명령을 내린다.
                    {
                        for (int dintUnit = 0; dintUnit <= this.PInfo.UnitCount; dintUnit++)
                        {
                            if (dstrModuleID == this.PInfo.Unit(dintUnit).SubUnit(0).ModuleID)
                            {
                                dbolLayerExist = true;
                                break;
                            }
                    ...
                    else   //52(Resume), 53(PM), 54(Normal)는 Layer1만 대응한다.(Layer2단 오면 NAK로 응답)
                    {
                        if (dstrModuleID != this.PInfo.Unit(0).SubUnit(0).ModuleID)
                        {
        ...
        //  Description   : Host로부터 현재 발생해 있는 AlarmList 조회
        //  Parameters    : None
        //  Return Value  : None
        ...
        //*******************************************************************************
        //  Function Name : PSecsDrv_S5F3()
        //  Description   : Host로부터 Alarm 보고 여부 설정
        //  Parameters    : None
        //  Return Value  : None
        //  Special Notes : S5F3 수신
        //*******************************************************************************
        //  2006/11/01          김 효주         [L 00]
        //******************************************************************************* 
        private void PSecsDrv_S5F3()
        {
            try
            {
                this.PInfo.subReceiveHostSF_Set("S5F3");
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        private void subS5F3()
        {
            ...
            {
                if (this.PInfo.All.HostConnect == false) return;
                if (funACTSECSAort_Send(this.PSecsDrv.S5F3.Header) == true) return;

                dintALED = Convert.ToInt32(this.PSecsDrv.S5F3.ALED);
                dintAlarmID = Convert.ToInt32(this.PSecsDrv.S5F3.ALID);

                if (this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID) == null)
                {
                    dintAck = 1;    //Spec에는 없으나 NAK로 응답함.
                }
                else
                {
                    if (dintALED == 0)          //Disable
                    {
                        //이미 Alarm 보고를 안하도록 설정되어 있는데 HOST에서 다시 Alarm 보고를 안하도록 내려오면 
                        if (this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmReport == false)  
                        {
                            dintAck = 1;    //Spec에는 없으나 NAK로 응답함.
                        }
                        else
                        {
                            ...
                            this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmReport = false;

                            //DB 업데이트
                            dstrSQL = "Update tbAlarm set AlarmReport='" + "FALSE" + "' Where AlarmID=" + dintAlarmID.ToString();

                            if (DBAct.clsDBAct.funExecuteQuery(dstrSQL) == false)
                            {
                                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, "DB Update Fail: AlarmID: " + dintAlarmID.ToString());
                            }
                        }
                    }
                    else if (dintALED == 1)     //Enable
                    {
                        //이미 Alarm 보고를 하도록 설정되어 있는데 HOST에서 다시 Alarm 보고를 하도록 내려오면 
                        if (this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmReport == true)
                        {
                            dintAck = 1;    //Spec에는 없으나 NAK로 응답함.
                        }
                        else
                        {
                            ...
                            this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmReport = true;

                            //DB 업데이트
                            dstrSQL = "Update tbAlarm set AlarmReport='" + "TRUE" + "' Where AlarmID=" + dintAlarmID.ToString();
                ...
                //HOST로 응답
                this.PSecsDrv.S5F4.ACKC5 = dintAck;
                this.PSecsDrv.S5F4.Reply(this.PSecsDrv.S5F3.Header);
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        //*******************************************************************************
        //  Function Name : PSecsDrv_S5F5()
        //  Description   : Host로부터 현재 설비에 등록된 Alarmlist 조회
        //  Parameters    : None
        //  Return Value  : None
        //  Special Notes : S5F5 수신
        //*******************************************************************************
        //  2006/11/01          김 효주         [L 00]
        //******************************************************************************* 
        private void PSecsDrv_S5F5()
        {
            try
            {
                this.PInfo.subReceiveHostSF_Set("S5F5");
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        private void subS5F5()
        {
            ...
            {
                if (this.PInfo.All.HostConnect == false) return;
                if (funACTSECSAort_Send(this.PSecsDrv.S5F5.Header) == true) return;


                dintAlarmCount = Convert.ToInt32(this.PSecsDrv.S5F5.ALARMCOUNT);
                if (dintAlarmCount == 0)
                {
                    this.PSecsDrv.S5F6.ALARMCOUNT = this.PInfo.Unit(0).SubUnit(0).AlarmCount;       //HOST로 보고할 Alarm 개수
                    foreach (int dintAlarmID in this.PInfo.Unit(0).SubUnit(0).Alarm())
                    {
                        dintIndex = dintIndex + 1;      //Index 증가
                        this.PSecsDrv.S5F6.set_ALCD(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmCode);
                        this.PSecsDrv.S5F6.set_ALID(dintIndex, dintAlarmID);
                        this.PSecsDrv.S5F6.set_ALTX(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmDesc);
                        this.PSecsDrv.S5F6.set_MODULEID(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).ModuleID);
                    }
                }
                else
                {
                    this.PSecsDrv.S5F6.ALARMCOUNT = dintAlarmCount;       //HOST로 보고할 Alarm 개수
                    for (int dintLoop = 1; dintLoop <= Convert.ToInt32(this.PSecsDrv.S5F5.ALARMCOUNT); dintLoop++)
                    {
                        dintIndex = dintIndex + 1;      //Index 증가

                        dintTemp = Convert.ToInt32(this.PSecsDrv.S5F5.get_ALID(dintLoop));      //AlarmID를 가져온다.
                        this.PSecsDrv.S5F6.set_ALCD(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintTemp).AlarmCode);
                        this.PSecsDrv.S5F6.set_ALID(dintIndex, dintTemp);
                        this.PSecsDrv.S5F6.set_ALTX(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintTemp).AlarmDesc);
                        this.PSecsDrv.S5F6.set_MODULEID(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintTemp).ModuleID);
                    }
                }

                //HOST로 응답
                this.PSecsDrv.S5F6.Reply(this.PSecsDrv.S5F5.Header);
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        //*******************************************************************************
        //  Function Name : PSecsDrv_S5F7()
        //  Description   : Host로부터 현재 HOST로 보고하는 Alarmlist 조회
        //  Parameters    : None
        //  Return Value  : None
        //  Special Notes : S5F7 수신
        //*******************************************************************************
        //  2006/11/01          김 효주         [L 00]
        //******************************************************************************* 
        private void PSecsDrv_S5F7()
        {
            try
            {
                this.PInfo.subReceiveHostSF_Set("S5F7");
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        private void subS5F7()
        {
            ...
            {
                if (this.PInfo.All.HostConnect == false) return;
                if (funACTSECSAort_Send(this.PSecsDrv.S5F7.Header) == true) return;
                ...
                foreach (int dintAlarmID in this.PInfo.Unit(0).SubUnit(0).Alarm())
                {
                    ...
                    {
                        dintIndex = dintIndex + 1;      //Index 증가
                        this.PSecsDrv.S5F8.set_ALCD(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmCode);
                        this.PSecsDrv.S5F8.set_ALID(dintIndex, dintAlarmID);
                        this.PSecsDrv.S5F8.set_ALTX(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).AlarmDesc);
                        this.PSecsDrv.S5F8.set_MODULEID(dintIndex, this.PInfo.Unit(0).SubUnit(0).Alarm(dintAlarmID).ModuleID);
                    }
                }

                this.PSecsDrv.S5F8.ALARMCOUNT = dintIndex;      //HOST로 보고하는 Alarm 개수

                //HOST로 응답
                this.PSecsDrv.S5F8.Reply(this.PSecsDrv.S5F7.Header);
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        //*******************************************************************************
        //  Function Name : PSecsDrv_S6F19()
        //  Description   : Host로부터 현재 GLS, LOT PDC List 조회
        //  Parameters    : None
        //  Return Value  : None
        //  Special Notes : S5F7 수신
        //*******************************************************************************
        //  2006/11/01          김 효주         [L 00]
        //******************************************************************************* 
        private void PSecsDrv_S6F19()
        {
            try
            {
                this.PInfo.subReceiveHostSF_Set("S6F19");
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        private void subS6F19()
        {
            ...
            {
                if (this.PInfo.All.HostConnect == false) return;
                if (funACTSECSAort_Send(this.PSecsDrv.S6F19.Header) == true) return;

                dstrModuleID = this.PSecsDrv.S6F19.MODUELID.Trim();
                dintRPTID = Convert.ToInt32(this.PSecsDrv.S6F19.RPTID);

                //ModuleID가 존재하지 않는 경우
                if (dstrModuleID != this.PInfo.Unit(0).SubUnit(0).ModuleID)
                {
                    this.PSecsDrv.S6F20.COUNT = 0; //ModuleID is not exist
                    this.PSecsDrv.S6F20.Reply(this.PSecsDrv.S6F19.Header);
                    return;
                }


                //RPTID가 존재하지 않는 경우(10: GLS BASE, 20: LOT BASE)
                if (dintRPTID == 10 || dintRPTID == 20)
                {
                    if (dintRPTID == 10)
                    {
                        this.PSecsDrv.S6F20.COUNT = this.PInfo.Unit(0).SubUnit(0).GLSAPDCount;
                        for (int dintLoop = 1; dintLoop <= this.PInfo.Unit(0).SubUnit(0).GLSAPDCount; dintLoop++)
                        {
                            this.PSecsDrv.S6F20.set_DATA_ITEM(dintLoop, this.PInfo.Unit(0).SubUnit(0).GLSAPD(dintLoop).Name);
                        }
                    }
                    else if (dintRPTID == 20)
                    {
                        this.PSecsDrv.S6F20.COUNT = this.PInfo.Unit(0).SubUnit(0).LOTAPDCount;
                        for (int dintLoop = 1; dintLoop <= this.PInfo.Unit(0).SubUnit(0).LOTAPDCount; dintLoop++)
                        {
                            this.PSecsDrv.S6F20.set_DATA_ITEM(dintLoop, this.PInfo.Unit(0).SubUnit(0).LOTAPD(dintLoop).Name);
                        }
                    }
        ...
        public void subSendMessage(object objSF)
        {
            ...
            try
            {
                ...
                switch (dstrSF)
                {
                    ...
                    case "CS6F11S6F11RelatedPanelIDValidationClass":
                        subACTSS6F11RelatedPanelIDValidationEvent_Send(objSF);
                        //subReplyCheck();
                        break;
            ...
            try
            {
                ...
                switch (Convert.ToInt32(darrEvent[0]))
                {
                    case (int)InfoAct.clsInfo.SFName.S1F1AreYouThereRequest:
                        SDIPDCLN.CAreYouThereClass S1F1 = new SDIPDCLN.CAreYouThereClass();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S5F1AlarmReportsend:
                        ...
                        SDIPDCLN.CS5F1Class S5F1 = new SDIPDCLN.CS5F1Class();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S6F11RelatedEquipmentEvent:
                        ...
                        SDIPDCLN.CS6F11RelatedEQPEventClass S6F11EQPEvent = new SDIPDCLN.CS6F11RelatedEQPEventClass();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S6F11RelatedPanelProcessEvent:
                        ...
                        SDIPDCLN.CS6F11RelatedPanelProcessClass S6F11RelatedPanel = new SDIPDCLN.CS6F11RelatedPanelProcessClass();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S6F11RelatedEquipmentParameterEvent:
                        ...
                        SDIPDCLN.CS6F11RelatedEQPParameterClass S6F11EQPParameter = new SDIPDCLN.CS6F11RelatedEQPParameterClass();
                        ...
                        switch (dintCEID)
                        {
                            case 101:
                                ...
                                {
                                    //if (Convert.ToInt32(dstrData[dintLoop - 1]) >= 4 && Convert.ToInt32(dstrData[dintLoop - 1]) <= 9)
                                ...
                                if (dint4Over > 0)
                                {
                                    for (int dintLoop = 1; dintLoop <= dintEOIDIndexCount; dintLoop++)
                                    {
                                        ...
                                        if (this.PInfo.funGetEOIDLapseTime(dintIndex) == true)
                                        {
                    ...
                    case (int)InfoAct.clsInfo.SFName.S6F11EquipmentSpecifiedControlEvent:
                        ...
                        SDIPDCLN.CS6F11EQPSpecifiedCtrlClass S6F11EQPSpecified = new SDIPDCLN.CS6F11EQPSpecifiedCtrlClass();
                    ...
                    //CEID = 111(PanelID Read Fail)
                    //CEID = 113(PanelID Mismatch)
                    //CEID = 114(Key_in Timeout)
                    case (int)InfoAct.clsInfo.SFName.S6F11RelatedPanelIDValidationEvent:
                        dintCEID = Convert.ToInt32(darrEvent[1]);                       //CEID
                        dintUnitID = Convert.ToInt32(darrEvent[2]);                     //UnitID
                        dstrLOTID = darrEvent[3];                                       //LOTID
                        dintSlotID = Convert.ToInt32(darrEvent[4]);                     //SlotID

                        SDIPDCLN.CS6F11RelatedPanelIDValidationClass S6F11RelatedPanelIDValidation = new SDIPDCLN.CS6F11RelatedPanelIDValidationClass();

                        S6F11RelatedPanelIDValidation.DATAID = 0;   //Fix
                        S6F11RelatedPanelIDValidation.CEID = dintCEID;
                        S6F11RelatedPanelIDValidation.RPTID1 = 0;   //Fix
                        S6F11RelatedPanelIDValidation.MCMD = this.PInfo.All.ControlState;
                        S6F11RelatedPanelIDValidation.MODULEID = this.PInfo.Unit(dintUnitID).SubUnit(0).ModuleID;
                        S6F11RelatedPanelIDValidation.MODULE_STATE = this.PInfo.Unit(dintUnitID).SubUnit(0).EQPState;
                        S6F11RelatedPanelIDValidation.PROC_STATE = this.PInfo.Unit(dintUnitID).SubUnit(0).EQPProcessState;
                        ...
                        S6F11RelatedPanelIDValidation.BYWHO = dintBYWHO;
                        S6F11RelatedPanelIDValidation.OPERID = this.PInfo.All.UserID;
                        S6F11RelatedPanelIDValidation.RPTID2 = 9;   //Fix

                        S6F11RelatedPanelIDValidation.BATCHID = this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).BATCHID;
                        S6F11RelatedPanelIDValidation.E_PANELID = this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).E_PANELID;
                        S6F11RelatedPanelIDValidation.PORTID = ""; //this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).PortID;
                        S6F11RelatedPanelIDValidation.CSTID = "";
                        S6F11RelatedPanelIDValidation.SLOTNO = FunStringH.funMakeLengthStringFirst(this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).SlotID.ToString(), 2);
                        S6F11RelatedPanelIDValidation.PANEL_SIZE = this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).PANEL_SIZE;

                        S6F11RelatedPanelIDValidation.PANEL_COUNT = 1;
                        S6F11RelatedPanelIDValidation.set_H_PANELID(1, this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).H_PANELID);
                        S6F11RelatedPanelIDValidation.set_SLOTNO1(1, FunStringH.funMakeLengthStringFirst(this.PInfo.LOTID(dstrLOTID).Slot(dintSlotID).SlotID.ToString(), 2));

                        return S6F11RelatedPanelIDValidation;
                    ...
                    //    SDIPDCLN.CS6F11RelatedMaterialEventClass S6F11RelatedMaterial = new SDIPDCLN.CS6F11RelatedMaterialEventClass();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S7F107PPIDCreatDeleteAndPPBodyChangedReport:
                        ...
                        SDIPDCLN.CS7F107Class S7F107 = new SDIPDCLN.CS7F107Class();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S6F13GLSAPD:
                        ...
                        SDIPDCLN.CS6F13GLSAPDClass S6F13GLSAPD = new SDIPDCLN.CS6F13GLSAPDClass();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S6F13LOTAPD:
                        ...
                        SDIPDCLN.CS6F13LOTAPDClass S6F13LOTAPD = new SDIPDCLN.CS6F13LOTAPDClass();
                    ...
                    case (int)InfoAct.clsInfo.SFName.S6F1TraceDataSend:
                        ...
                        SDIPDCLN.CS6F1 S6F1 = new SDIPDCLN.CS6F1();
        ...
        private void subACTAreYouThere_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CAreYouThereClass dclsSF = (SDIPDCLN.CAreYouThereClass)objSF;
        ...
        private void subACTS5F1_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS5F1Class dclsSF = (SDIPDCLN.CS5F1Class)objSF;
        ...
        private void subACTS6F1_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F1 dclsSF = (SDIPDCLN.CS6F1)objSF;
        ...
        private void subACTS6F11RelatedPanelProcess_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F11RelatedPanelProcessClass dclsSF = (SDIPDCLN.CS6F11RelatedPanelProcessClass)objSF;
        ...
        private void subACTS6F11RelatedEQPEvent_Send(object objSF)
        {
            ...
            {
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F11RelatedEQPEventClass dclsSF = (SDIPDCLN.CS6F11RelatedEQPEventClass)objSF;
        ...
        private void subACTS6F11RelatedEQPParameter_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F11RelatedEQPParameterClass dclsSF = (SDIPDCLN.CS6F11RelatedEQPParameterClass)objSF;
        ...
        private void subACTSS6F11EQPSpecifiedCtrl_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F11EQPSpecifiedCtrlClass dclsSF = (SDIPDCLN.CS6F11EQPSpecifiedCtrlClass)objSF;
        ...
        private void subACTSS6F11S6F11RelatedMaterialEvent_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F11RelatedMaterialEventClass dclsSF = (SDIPDCLN.CS6F11RelatedMaterialEventClass)objSF;
        ...
        //*******************************************************************************
        //  Function Name : subACTSS6F11RelatedPanelIDValidationEvent_Send()
        //  Description   : HOST로 Online 전환 요청을 한다.
        //  Parameters    : objSF => S/F의 인스턴스
        //  Return Value  : None
        //  Special Notes : S1F13 송신
        ...
        //  2006/10/27          김 효주         [L 00]
        //******************************************************************************* 
        private void subACTSS6F11RelatedPanelIDValidationEvent_Send(object objSF)
        {
            try
            {
                if (this.PInfo.All.ControlState == "1" || this.PInfo.All.HostConnect == false) return;
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F11RelatedPanelIDValidationClass dclsSF = (SDIPDCLN.CS6F11RelatedPanelIDValidationClass)objSF;

                this.PSecsDrv.S6F11RelatedPanelIDValidation.CopyMessage(dclsSF);
                this.PSecsDrv.S6F11RelatedPanelIDValidation.Request();
            }
            catch (Exception ex)
            {
                this.PInfo.subLog_Set(InfoAct.clsInfo.LogType.CIM, ex.ToString());
        ...
        private void subACTS6F13GLSAPD_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F13GLSAPDClass dclsSF = (SDIPDCLN.CS6F13GLSAPDClass)objSF;
        ...
        private void subACTS6F13LOTAPD_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS6F13LOTAPDClass dclsSF = (SDIPDCLN.CS6F13LOTAPDClass)objSF;
        ...
        private void subACTS7F107_Send(object objSF)
        {
            try
            {
                ...
                //형변환을 명시적으로 한다.
                SDIPDCLN.CS7F107Class dclsSF = (SDIPDCLN.CS7F107Class)objSF;
