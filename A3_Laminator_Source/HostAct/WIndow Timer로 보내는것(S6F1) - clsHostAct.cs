...
namespace HostAct
{
    public class clsHostAct
    {
        #region "선언"
            ...
            private System.Windows.Forms.Timer ptmrSVIDSend;            //LOG를 Write할 타이머 정의  
        ...
        public Boolean funThreadInitial()
        {
            try
            {
                ...
                this.ptmrSVIDSend = new System.Windows.Forms.Timer();
                this.ptmrSVIDSend.Tick += new EventHandler(SVIDSend);
                this.ptmrSVIDSend.Interval = 1000;      //500ms
                this.ptmrSVIDSend.Enabled = true;
                //GC.KeepAlive(this.ptmrSVIDSend);
        ...
        //void SVIDSend()
        private void SVIDSend(Object Object, EventArgs EventArgs)
        {
            int dintGroupCnt = 0;
            string[] dstrValue;
            string dstrData = "";
