...
namespace CommonAct
{
    public class FunDataGridView
    {
        ...
        //*******************************************************************************
        //  Function Name : subDisplayDataGridView()
        //  Description   : DataGridView에 DataTable을 Binding(출력)한다.
        //  Parameters    : grdDataGridView => DataGridView
        //                  dtDataTable     => 바인딩하고자 하는 DataTable
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에 바인딩된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subDisplayDataGridView()
        //  Description   : DataGridView에 BindingSource개체를 Binding(출력)한다.
        //  Parameters    : grdDataGridView     => DataGridView
        //                  bsBindingSource     => 바인딩하고자 하는 BindingSource개체
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에 바인딩된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        ...
        //*******************************************************************************
        //  Function Name : subAddRow()
        //  Description   : DataGridView에 새로운 행을 추가한다.
        //  Parameters    : grdDataGridView     => DataGridView
        //                  strArrRowData       => 행 데이터
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에 행이 추가된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //  2007/03/06          김 효주         [L 01]  DataGridView에 바인딩 된 
        //                              DataSource가 DataTable or BindingSource 경우로 분리
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subDeleteRow()
        //  Description   : DataGridView에서 행을 삭제한다.
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intRowIndex         => 행 인덱스
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에 행이 삭제된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subUpdateRow()
        //  Description   : DataGridView에서 행을 수정한다.
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intRowIndex         => 행 인덱스
        //                  strArrRowData       => 변경할 행 데이터
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에서 행이 업데이트된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //  2007/03/06          김 효주         [L 01]  DataGridView에 바인딩 된 
        //                              DataSource가 DataTable or BindingSource 경우로 분리
        ...
        //*******************************************************************************
        //  Function Name : subAddColumn()
        //  Description   : DataGridView에 새로운 컬럼을 추가한다.
        //  Parameters    : grdDataGridView     => DataGridView
        //                  strColumnName       => 컬럼 이름
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에 컬럼이 추가된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //                  strColumnName       => 컬럼 이름
        //                  intColumnIndex      => 컬럼 인덱스
        //                  strColumnHeaderText => 컬럼 HeaderText
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에 컬럼이 추가된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        ...
        //*******************************************************************************
        //  Function Name : subDeleteColumn()
        //  Description   : DataGridView에서 컬럼을 삭제한다.(ColumnName으로)
        //  Parameters    : grdDataGridView     => DataGridView
        //                  strColumnName       => 컬럼 이름
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에서 컬럼이 삭제된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subDeleteColumn()
        //  Description   : DataGridView에서 컬럼을 삭제한다.(ColumnIndex로)
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intColumnIndex      => 컬럼 인덱스
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView에서 컬럼이 삭제된다.
        ...
        //*******************************************************************************
        //  Function Name : subUpdateCell()
        //  Description   : DataGridView에서 셀 데이터를 수정한다.(한 셀 Data만 수정)
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intRowIndex         => RowIndex
        //                  strColumnName       => 컬럼 Name
        //                  strCellData         => 변경하려고 하는 셀 Data
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView의 셀 Data가 수정된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subUpdateCellBlock()
        //  Description   : DataGridView에서 컬럼 데이터를 수정한다.(Row범위를 지정해서 Data를 수정)
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intStartRowIndex    => 시작 RowIndex
        //                  intEndRowIndex      => 끝 RowIndex
        //                  strColumnName       => 컬럼 Name
        //                  strArrCellData      => 변경하려고 하는 셀 Data
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView의 셀 Data가 수정된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        ...
        //*******************************************************************************
        //  Function Name : subUpdateCellBlock()
        //  Description   : DataGridView에서 Cell 데이터를 수정한다.(Block 범위로 수정)
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intStartRowIndex    => 시작 RowIndex
        //                  intEndRowIndex      => 끝 RowIndex
        //                  intStartColumnIndex => 시작 ColumnIndex
        //                  intEndColumnIndex   => 끝 ColumnIndex
        //                  strArrCellData      => 변경하려고 하는 셀 Data
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView의 셀 Data가 수정된다.
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subResizeColumnWidth()
        //  Description   : DataGridView의 ColumnWidth를 조절한다.
        //  Parameters    : grdDataGridView     => DataGridView
        //                  objArrColumnWidth   => 변경하려고 하는 셀 Width
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView의 셀 Width가 변경된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subChangeRowStyle()
        //  Description   : DataGridView에서 Row의 CellStyle을 변경한다.(Row범위를 지정해서 수정)
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intStartRowIndex    => 시작 RowIndex
        //                  intEndRowIndex      => 끝 RowIndex
        //                  cBackColor          => Row의 배경색
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView의 RowStyle이 변경된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : subChangeColumnStyle()
        //  Description   : DataGridView에서 Column의 CellStyle을 변경한다.(Column 전체를 수정)
        //  Parameters    : grdDataGridView     => DataGridView
        //                  intColumnIndex      => 컬럼 Index
        //                  cBackColor          => Row의 배경색
        //  Return Value  : 
        //  Special Notes : 메소드 호출시 자동으로 DataGridView의 ColumnStyle이 변경된다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funDataTableTo2Array()
        //  Description   : DataTable -> 2차원배열로 변환한다.
        //  Parameters    : dtDataTable     => DataTable
        //  Return Value  : 2차원배열
        //  Special Notes : 
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        ...
        //*******************************************************************************
        //  Function Name : fun2ArrayToDataTable()
        //  Description   : 2차원배열 -> DataTable로 변환한다.
        //  Parameters    : strArr              => 2차원배열
        //                  strArrColumnHeader  => ColumnHeader 텍스트
        ...
        //*******************************************************************************
        //  Function Name : funArrayListToDataTable()
        //  Description   : ArrayList -> DataTable로 변환한다.
        //  Parameters    : ArrList             => ArrayList
        //                  strDelimiter        => 구분자(Delimiter)
        //                  strArrColumnHeader  => ColumnHeader 텍스트
        //  Return Value  : DataTable
        //  Special Notes : 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funDataTableToArrayList()
        //  Description   : DataTable -> ArrayList로 변환한다.
        //  Parameters    : dtDataTable     => DataTable
        //                  strDelimiter    => 구분자(Delimiter)
        ...
        //*******************************************************************************
        //  Function Name : fun1ArrayToDataTable()
        //  Description   : 1차원배열 -> DataTable로 변환한다.
        //  Parameters    : strArrData          => 1차원배열
        //  Return Value  : 1차원배열을 DataTbale로 변환한 것
        //  Special Notes : 1차원 배열 값이 0,1,2, ... , 19까지 20개가 있으면
        ...
        //  Description   : 1차원배열 -> DataTable로 변환한다.
        //  Parameters    : strArrData          => 1차원배열
        //                  intColumnCount      => DataTable의 컬럼개수
        //  Return Value  : 1차원배열을 DataTbale로 변환한 것
        //  Special Notes : 1차원 배열 값이 0,1,2, ... , 19까지 20개가 있으면
        //                  인자로 넘어온 DataTable의 Column개수로 잘라서 DataTable을 생성한다.
        //*******************************************************************************
        ...
        //  Parameters    : strArrData          => 1차원배열
        //                  intColumnCount      => DataTable의 컬럼개수
        //                  strArrColumnHeader  => DataTable의 ColumnHeader 텍스트
        //  Return Value  : 1차원배열을 DataTbale로 변환한 것
        //  Special Notes : 1차원 배열 값이 0,1,2, ... , 19까지 20개가 있으면
        //                  인자로 넘어온 DataTable의 Column개수로 잘라서 DataTable을 생성한다.
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funDataTableTo1Array()
        //  Description   : DataTable -> 1차원배열로 변환한다.
        //  Parameters    : dtDataTable      => DataTable
        //  Return Value  : 1차원배열
        //  Special Notes : 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : fun1ArrayToArrayList()
        //  Description   : 1차원배열 -> ArrayList로 변환한다.
        //  Parameters    : strArrData      => 1차원배열
        //  Return Value  : ArrayList
        //  Special Notes : 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funArrayListTo1Array()
        //  Description   : ArrayList -> 1차원배열로 변환한다.
        //  Parameters    : ArrList      => ArrayList
        //  Return Value  : 1차원배열
        //  Special Notes : 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funAddRowToDataTable()
        //  Description   : 인자로 넘어온 DataTable에 새행을 추가해서 DataTable을 리턴한다.
        //  Parameters    : dtDataTable      => DataTable
        //                  strArrRowData    => 추가할 행 데이터
        //  Return Value  : 새행을 추가한 DataTable
        //  Special Notes : 리턴된 DataTable을 응용 프로그램단에서 바인딩해주어야 한다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funDeleteRowFromDataTable()
        //  Description   : 인자로 넘어온 DataTable에서 행을 삭제하여 DataTable을 리턴한다.
        //  Parameters    : dtDataTable         => DataTable
        //                  intRowIndex         => 행 인덱스
        //  Return Value  : 행을 삭제한 DataTable
        //  Special Notes : 리턴된 DataTable을 응용 프로그램단에서 바인딩해주어야 한다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funUpdateRowFromDataTable()
        //  Description   : 인자로 넘어온 DataTable에서 행을 수정하여 DataTable을 리턴한다.
        //  Parameters    : dtDataTable         => DataTable
        //                  intRowIndex         => 행 인덱스
        //                  strArrRowData       => 변경할 행 데이터
        //  Return Value  : 행을 수정한 DataTable
        //  Special Notes : 리턴된 DataTable을 응용 프로그램단에서 바인딩해주어야 한다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funUpdateCellFromDataTable()
        //  Description   : 인자로 넘어온 DataTable에서 셀내용을 수정하여 DataTable을 리턴한다.
        //  Parameters    : dtDataTable         => DataTable
        //                  intRowIndex         => 행 인덱스
        //                  strColumnName       => 컬럼Name
        //                  strCellData         => 변경하려고 하는 셀 Data
        //  Return Value  : 셀내용을 수정한 DataTable
        //  Special Notes : 리턴된 DataTable을 응용 프로그램단에서 바인딩해주어야 한다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
        ...
        //*******************************************************************************
        //  Function Name : funDataTablePerPage()
        //  Description   : 인자로 넘어온 DataTable에서 RowCount만큼 잘라서 해당 Page번호
        //                  에 해당하는 DataTable을 리턴한다.
        //  Parameters    : dtDataTable         => DataTable
        //                  intRowCount         => 행 개수
        //                  intPageNo           => Page에 해당하는 DataTable
        //  Return Value  : DataTable
        //  Special Notes : 리턴된 DataTable을 응용 프로그램단에서 바인딩해주어야 한다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        ...
        //*******************************************************************************
        //  Function Name : funAddColumn()
        //  Description   : DataTable에 새로운 컬럼을 추가한다.
        //  Parameters    : dtDataTable         => DataTable
        //                  strColumnName       => 컬럼 이름
        //                  strColumnHeaderText => 컬럼 HeaderText
        //  Return Value  : 컬럼을 추가한 DataTable
        //  Special Notes : 리턴된 DataTable을 응용 프로그램단에서 바인딩해주어야 한다.
        //*******************************************************************************
        //  2007/02/15          김 효주         [L 00] 
        //*******************************************************************************
