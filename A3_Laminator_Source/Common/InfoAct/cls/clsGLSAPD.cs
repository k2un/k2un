...
namespace InfoAct
{
    public class clsGLSAPD
    {
        ...
        public bool HostReportFlag = false;
        ...
        public void CopyFrom(clsGLSAPD glsApd)
        {
            this.Name = glsApd.Name;
            this.Length = glsApd.Length;
            this.Format = glsApd.Format;
            this.ModuleID = glsApd.ModuleID;
        }
    }
}
