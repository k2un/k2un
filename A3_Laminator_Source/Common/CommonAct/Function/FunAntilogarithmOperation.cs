...
namespace CommonAct
{
    public class FunAntilogarithmOperation
    {
        ...
        /// <summary>
        /// Asc Code Data 를 원하는 Data 로 바꾸어 준다
        /// </summary>
        /// <param name="strData">ASCII Code Data</param>
        /// <param name="StringType">바꾸고자 하는 Type</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="strHexData">Hex Data(41 4243 4445 4647)</param>
        /// <returns>Swap Data(4100 4342 4544 4746)</returns>
        ...
        /// <summary>
        /// 어드레스를 원하는 단위 자릿수의 배수만큼 0으로 채워준다.
        /// </summary>
        /// <param name="Address">16진수 어드레스(34)</param>
        /// <param name="Step">0을 채워서 증가할 단위 자릿수(4)</param>
        /// <param name="direction">0을 채울 방향 ,true -> 앞, false -> 뒤</param>
        /// <returns>바뀐 어드레스(0034)</returns>
        /// <comment>
        /// step 을 4로 설정하고 5자리로 데이터가 들어온 경우
